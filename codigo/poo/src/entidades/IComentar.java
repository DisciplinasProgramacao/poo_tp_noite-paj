...
public interface IComentar{
	...
	private static boolean podeComentar(SortedMap<LocalDate,Midia> listaMidiasAvaliadas) {
	...
	public static void comentar(String msg,Midia midia,SortedMap<LocalDate,Midia> listaMidiasAvaliadas, String usuario) throws AvaliacaoInsuficienteException {
